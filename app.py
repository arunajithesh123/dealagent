...
# Inline CSS so styles load reliably in production (e.g. Render)
st.markdown(
    """
<style>
...
.agent-step-main { flex: 1; display: flex; flex-direction: column; gap: 2px; }
.agent-step-title { font-weight: 600; font-size: 15px; }
.agent-step-subtitle { font-size: 12px; color: #9ca3af; }
.agent-step-status { font-size: 11px; text-transform: uppercase; letter-spacing: 0.08em; color: #9ca3af; }
.agent-step.active {
    border-left: 3px solid #6366f1;
    box-shadow: 0 0 0 1px rgba(99, 102, 241, 0.45), 0 16px 38px rgba(15, 23, 42, 0.9);
    animation: pulse 1.4s ease-in-out infinite;
}
.agent-step.complete {
    border-left: 3px solid #22c55e;
    box-shadow: 0 0 0 1px rgba(34, 197, 94, 0.4), 0 14px 32px rgba(15, 23, 42, 0.8);
}
...
.stButton > button {
    ...
    transition: transform 0.12s ease-out, box-shadow 0.12s ease-out, filter 0.12s ease-out, border-color 0.12s ease-out;
}
...
.graph-node--company { border-color: #6366f1; box-shadow: 0 0 0 1px rgba(99, 102, 241, 0.4); }
.graph-node--painpoint { border-color: #f97316; }
.graph-node--source { border-color: #22c55e; }
/* Scrollbar */
...
@keyframes pulse {
    0% { box-shadow: 0 0 0 0 rgba(99, 102, 241, 0.58), 0 16px 38px rgba(15, 23, 42, 0.9); }
